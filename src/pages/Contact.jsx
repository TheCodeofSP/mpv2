...
import "./contact.scss";
import { FiMail, FiPhone, FiCheckCircle, FiAlertCircle, FiCopy } from "react-icons/fi";
...
export default function Contact() {
  ...
  const submitLabel = t("contact.content.form.submit.label", "Envoyer ma demande");
  const responseTime = t("contact.content.form.helper.responseTime", "");

  const profileOptionsRaw = node(profileSelect?.optionsPath || "home.profileSelector.options");
  ...
  const copy = useMemo(() => {
    return {
      chooseProfile: isTu ? "Choisis ton profil." : "Veuillez choisir votre profil.",
      chooseTopic: isTu ? "Précise ta demande." : "Veuillez préciser votre demande.",
      enterName: isTu ? "Indique ton nom." : "Veuillez renseigner votre nom.",
      enterEmail: isTu ? "Indique ton email." : "Veuillez renseigner votre email.",
      invalidEmail: "Email invalide.",
      shortMsg: isTu
        ? "Ton message est trop court (min. 10 caractères)."
        : "Votre message est trop court (min. 10 caractères).",
      consent: isTu ? "Merci de confirmer ton accord." : "Merci de confirmer votre accord.",
      globalError: isTu
      ...
      formTitle: isTu ? "Parlons de ta situation" : "Parlons de votre situation",
        ...
        <div className="contact__container">
          ...
          <div className="contact__layout">
            ...
            <aside className="contact__side">
              ...
              <ServiceArea variant="highlight" showMap mapQuery="Strasbourg, France" />
            </aside>

            {/* Colonne droite */}
            <section className="contact__main">
              <div className="contact__card contact__card--reveal">
                <h2 className="contact__h2">{t("contact.ui.formTitle", copy.formTitle)}</h2>
                ...
                <form className="contact__form" onSubmit={onSubmit} noValidate>
                  ...
                  <div className="contact__grid">
                    ...
                    {/* Consent */}
                    <div className="contact__field contact__field--full">
                      <label className={`contact__consent ${showError("consent") ? "has-error" : ""}`}>
                        <input
